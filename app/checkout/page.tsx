    ...
    async function run() {
      try {
        ...
        if (!window.Paddle?.Checkout?.open) {
          throw new Error("Paddle Checkout не доступний (не завантажився SDK)");
        }

        // Відкриваємо checkout по transactionId
        window.Paddle.Checkout.open({
          transactionId: ptxn,

          // опційно: можна відловлювати події
          // eventCallback: (ev: any) => {
          //   console.log("Paddle event:", ev);
          // },

          // якщо у тебе є successUrl/cancelUrl на бекенді — краще там,
          // але на всякий — залишимо клієнтські fallback-роути:
