                                    ...
                                    <Stack gap={3}>
                                                ...
                                                >
                                                    <Stack gap={0.5}>
                                                        ...
                                                        <Typography
                                                            ...
                                                            sx={{ color: '#6b7280' }}
                                                        >
                                                            Документи цієї бази знань привʼязані саме до
                                                            цього бізнес-акаунта.
                                                        </Typography>
                                                    </Stack>
                                                    <Stack
                                                        alignItems={{
                                        ...
                                        >
                                            <Stack gap={2}>
                                                ...
                                                {docsError && (
                                                    <Typography variant="body2" color="#b91c1c">
                                                        Помилка завантаження документів:{' '}
                                                ...
                                                {!docsLoading && documents.length === 0 && (
                                                    ...
                                                    >
                                                        ...
                                                        контракт, комерційну пропозицію або FAQ — і
                                                        асистент зможе ними користуватись.
                                                    </Typography>
                                                )}
                                                                        ...
                                                                        >
                                                                            ...
                                                                            >
                                                                                ...
                                                                                <Box>
                                                                                    ...
                                                                                    >
                                                                                        {res.document.originalName} ·
                                                                                        фрагмент #{res.chunkIndex + 1}
                                                                                    </Typography>
                                                                                    <Typography
                                                                                        variant="body2"
                                                                                        sx={{
            ...
            >
                ...
                >
                    <Stack spacing={2.5} sx={{paddingTop: '5px'}}>
                        ...
                        {uploadError && (
                            <Typography variant="body2" color="#b91c1c">
                                Помилка завантаження: {(uploadError as Error).message}
                            </Typography>
                        )}
                    </Stack>
                </DialogContent>
