...
const benefits = [
  ...
  },
  {
    ...
    description:
      "нічого не треба налаштовувати, сервіс уже заточений під бізнес.",
  },
  {
    ...
    <Box sx={{ bgcolor: "#f5f5f5", minHeight: "100vh" }}>
      ...
      <Box sx={{ bgcolor: "white", py: { xs: 6, sm: 10, md: 16 } }}>
        <Container maxWidth="md">
          <Box sx={{ textAlign: "center", px: { xs: 2, sm: 3, md: 0 } }}>
            ...
            >
              Інструмент, який допомагає малому бізнесу швидше відповідати
              клієнтам, створювати контент, працювати з документами та приймати
              рішення — без складних налаштувань і зайвих витрат.
            </Typography>
            <Stack
      ...
      <Container maxWidth="lg" sx={{ py: { xs: 6, sm: 10, md: 14 } }}>
        ...
        >
          ...
          >
            Це не просто AI-чат. Це асистент, який знає твій бізнес, памʼятає
            інформацію, працює з твоїми документами, допомагає з клієнтами та
            контентом — і завжди під рукою.
          </Typography>
        </Box>
        ...
        {/* Features */}
        <Box
          sx={{ mb: { xs: 6, sm: 10, md: 14 }, px: { xs: 2, sm: 3, md: 0 } }}
        >
          <Typography
            variant="h2"
            sx={{
        ...
        {/* Security */}
        <Box
          sx={{ maxWidth: "1000px", mx: "auto", px: { xs: 2, sm: 3, md: 0 } }}
        >
          <Paper
            elevation={0}
            sx={{
          ...
          >
            ...
            <Grid container spacing={{ xs: 4, sm: 5 }} justifyContent="center">
              {[
                ...
                {
                  icon: "✓",
                  text: "Ми не передаємо інформацію третім сторонам",
                },
              ].map((item, idx) => (
      ...
      <Box sx={{ bgcolor: "white", py: { xs: 6, sm: 10, md: 14 } }}>
        <Container maxWidth="md">
          <Box sx={{ textAlign: "center", px: { xs: 2, sm: 3, md: 0 } }}>
            ...
            >
              Зареєструйся, створи профіль бізнесу — і отримай свого особистого
              AI-асистента протягом декількох хвилин.
            </Typography>
            <Stack
              direction={{ xs: "column", sm: "row" }}
              spacing={{ xs: 2, sm: 2.5 }}
        ...
        <Container maxWidth="lg">
          ...
          >
            ...
            <Grid item xs={12} sm={6} md={3}>
              ...
              <Typography
                variant="body2"
                sx={{ opacity: 0.7, fontSize: { xs: "0.9rem", sm: "0.95rem" } }}
              >
                Умови користування
              </Typography>
            </Grid>
